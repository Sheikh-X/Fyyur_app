...
Revision ID: 350cfe3f66ec
Revises: 80cfeed7d536
Create Date: 2022-08-21 22:48:20.520330
...
revision = '350cfe3f66ec'
down_revision = '80cfeed7d536'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('website_link', sa.VARCHAR(length=140), autoincrement=False, nullable=True),
    sa.Column('seeking_talent', sa.BOOLEAN(), autoincrement=False, nullable=True),
    sa.Column('seeking_description', sa.VARCHAR(length=140), autoincrement=False, nullable=True),
